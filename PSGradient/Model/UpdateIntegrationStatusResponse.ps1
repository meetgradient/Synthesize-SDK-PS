...
UpdateIntegrationStatusResponse<PSCustomObject>
#>

function Initialize-PSUpdateIntegrationStatusResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSGradient => PSUpdateIntegrationStatusResponse' | Write-Debug
...
Convert from JSON to UpdateIntegrationStatusResponse<PSCustomObject>
...
UpdateIntegrationStatusResponse<PSCustomObject>
#>
function ConvertFrom-PSJsonToUpdateIntegrationStatusResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSGradient => PSUpdateIntegrationStatusResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSUpdateIntegrationStatusResponse
