...
VendorSkuData<PSCustomObject>
#>

function Initialize-PSVendorSkuData {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSGradient => PSVendorSkuData' | Write-Debug
...
Convert from JSON to VendorSkuData<PSCustomObject>
...
VendorSkuData<PSCustomObject>
#>
function ConvertFrom-PSJsonToVendorSkuData {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSGradient => PSVendorSkuData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSVendorSkuData
        $AllProperties = ("_id", "id", "name", "description", "logo", "category", "subcategory", "supportArticle", "supportContact")
