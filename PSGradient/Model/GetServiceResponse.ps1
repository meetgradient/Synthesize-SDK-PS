...
GetServiceResponse<PSCustomObject>
#>

function Initialize-PSGetServiceResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSGradient => PSGetServiceResponse' | Write-Debug
...
Convert from JSON to GetServiceResponse<PSCustomObject>
...
GetServiceResponse<PSCustomObject>
#>
function ConvertFrom-PSJsonToGetServiceResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSGradient => PSGetServiceResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSGetServiceResponse
