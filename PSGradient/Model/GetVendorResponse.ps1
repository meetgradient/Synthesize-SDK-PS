...
GetVendorResponse<PSCustomObject>
#>

function Initialize-PSGetVendorResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSGradient => PSGetVendorResponse' | Write-Debug
...
Convert from JSON to GetVendorResponse<PSCustomObject>
...
GetVendorResponse<PSCustomObject>
#>
function ConvertFrom-PSJsonToGetVendorResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSGradient => PSGetVendorResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PSGetVendorResponse
